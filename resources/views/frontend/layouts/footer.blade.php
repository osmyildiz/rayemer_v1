                ...
                <div class="col-md-6 col-lg-3 mb-lg-0 mb-4">
                    <div class="widget-wrap about-widget mb-5">
                        ...
                        <div class="widget-content">
                            <p>Üniversite hazırlık kursundan, lise hazırlık kursuna kadar işini sevgiyle yapanların buluştuğu bir kurs merkeziyiz.</p>
                        </div><!--.widget-content -->
                    </div><!--.widget-wrap -->
                            ...
                            <div class="mailchimp-wrapper">
                                <form class="subscribe-form" action="inc/function.php">
                                    ...
                                    <div class="input-group form-group mb-3 input-with-btn">
                                        <input type="text" name="mcemail" class="form-control" placeholder="Email">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="submit"><span class="ti-arrow-right"></span></button>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="widget-wrap company-links-widget">
                        ...
                        <div class="widget-content">
                            <ul class="nav flex-column nav-light-to-theme icon-nav">
                                <li class="nav-item"><a href="#" class="nav-link">TYT- AYT</a></li>
                                <li class="nav-item"><a href="#" class="nav-link">LGS</a></li>
                                <li class="nav-item"><a href="#" class="nav-link">Lise Arasınıf</a></li>
                                <li class="nav-item"><a href="#" class="nav-link">Ortaokul Arasınıf</a></li>
                                <li class="nav-item"><a href="#" class="nav-link">Bire-bir</a></li>
                            </ul>
                        </div><!--.widget-content -->
                    </div><!--.widget-wrap -->
                </div><!-- .col -->
                    ...
                    <div class="widget-wrap contact-info-widget">
                        ...
                        <div class="widget-content">
                            <ul class="nav flex-column nav-light-to-theme">
                                ...
                                <li class="nav-item"><span class="ti-mobile contact-icons"></span><a href="#" class="nav-link">0216 5493049</a></li>
                                <li class="nav-item"><span class="ti-mobile contact-icons"></span><a href="#" class="nav-link">0552 5493049</a></li>
                    ...
                    <div class="widget-wrap post-tags-widget">
                        ...
                        <div class="widget-content">
                            <ul class="nav post-tags-list">
                                <li><a href="#" class="post-tags btn btn-outline-dark">Üniversite Hazırlık</a></li>
                                <li><a href="#" class="post-tags btn btn-outline-dark">TYT</a></li>
                                <li><a href="#" class="post-tags btn btn-outline-dark">AYT</a></li>
                                <li><a href="#" class="post-tags btn btn-outline-dark">YKS</a></li>
                                <li><a href="#" class="post-tags btn btn-outline-dark">LGS</a></li>
                                <li><a href="#" class="post-tags btn btn-outline-dark">Liselere Giriş</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-auto mb-2 mb-md-0 text-center text-md-left">
                    <div class="logo-wrap">
                        <a href="index.html" class="site-logo"><img class="img-fluid" src="images/logo/logo_main1.png" alt="Mist"></a>
                    </div>
                </div>
